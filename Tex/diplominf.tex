...
\begin{figure}
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay_L06_I03.png}}
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay9_L06_I03.png}}
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay8_L06_I03.png}}
	
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay_L07_I06.png}}
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay9_L07_I06.png}}
	\subfigure[]{\includegraphics[width=.3\textwidth]{img/delaunay8_L07_I06.png}}
\end{figure}

\begin{figure}
	\includegraphics[width=\textwidth]{../results/6/512x512_Delaunay/T0.8/G0.8/delaunay.png}
	\caption{$\delta = 0.8, \gamma = 0.8$}
\end{figure}
