...
Dabei werden dem Client zusätzlich zum Farbbild weitere Tiefeninformationen in Form von Dreiecksnetzen übermittelt.
Die Dreiecksnetze werden vom Server durch die vorgestellten Methoden erzeugt.
Dabei repräsentieren die Dreiecksnetze die Grauwertverläufe, der bei der Bildsynthese
anfallenden Tiefenbilder.
Der Browser-basierte Client erzeugt mit Hilfe der Netze und dem Farbbild als Textur,
approximierte Versionen 
