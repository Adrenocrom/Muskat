...
Das führt dazu, das die Dreiecksnetze der Szene \textit{CoolRandom} aus vielmehr Dreiecken
...
Planaren Flächen bestehen ebenso aus zu vielen Dreiecken.
...
Wobei der Parameter $i$ vorwiegend die Unterteilung gekrümmter
Flächen bestimmt, bei kleinen Winkeln wird die Güte selbst bei einer gröberen Unterteilung kaum verschlechtert.
Es sind große Werte für $l$ zum Empfehlen, beispielsweise $0.7$.
Der Parameter $i$ sollte nicht mit $0$ gewählt werden, sollte jedoch kleiner
oder gleich $l$ sein. 
...
Dieser Effekt wird in der Szene \textit{CoolRandom} besonders deutliche.
...
sodass hier eine gute Approximation bis zu 20 Grad Winkelunterschied möglich ist.
