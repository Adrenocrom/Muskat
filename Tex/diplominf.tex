...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\draw (0,0) -- 
			plot[mark=*, mark options={fill=green}] (0,0) node[right]{$\alpha = 10$, $\beta = 0.2$};
		\draw[yshift=\baselineskip] (0,0) -- 
			plot[mark=*, mark options={fill=blue}] (0,0) node[right]{$t_{max} = 9$, ohne Optimierung};
		\draw[yshift=2\baselineskip] (0,0) -- 
...
Dabei wurden die Parameter $l = 0.7$ und $i = 0.6$ für alle Netze gewählt.
...
und das optimierte Netz aus 17997 Dreiecken.
