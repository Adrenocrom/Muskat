\documentclass[hyperref,german,diplominf,final,lof,lot]{cgvpub}
...
Die folgenden Diagramme zeigen die erhobenen Daten, in den Legenden,
wird \textit{Quadtree} mit QT und \textit{FloydSteinberg} mit FS abgekürzt.
...
Es zeigt sich die klare Tendenz, dass größere Maximaltiefen zu besseren Ergebnissen führen.
...
In diesem Kapitel, werden die zuvor präsentierten Daten ausgewertet.
Die besten Resultate, der verschieden Varianten liefern die in der Abbildung \ref{fig:Daten_best_cases} 
abgebildeten Parameterkonfigurationen.
Wobei diese auch die meisten Dreiecke produzieren.
