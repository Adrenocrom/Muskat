...
Auch wenn die Kompression und kompakte Darstellung der Dreiecksnetze nicht teil dieser Arbeit sind,
...
Zur Verwaltung der Anfragen wird auf das Event-Managementsystem von QT verwendet. 
Beim Start der Serveranwendung werden die Szenen geladen.
Aus diesen wird eine \textit{Playlist} erstellt, die die Informationen aller Szenen
vereint.
...
weilt die gesamte Kommunikation synchronisiert stattfindet.
...
Wurde die Anfrage empfangen und die Methode ausgeführt, wird eine Antwort zurückgesendet.
...
Anschließend schickt er eine Antwort an den Klient zurück, wie im Beispiel \ref{lst:jsonrpc_response_resize} demonstriert.
...
Nachdem alle Szenen bekannt sind, wird eine Szene geladen.
...
Der empfangene Frame, kann vom Klient beliebig extrapoliert werden.
...
\section{Implentierung der Algorithmen}
...
Es ist möglich eine Schwellwert zu bestimmen, der mit den Gradienten im Tiefenbild vergleichen wird.
Wird der Schwellwert überschritten, dann werden die entsprechenden Fragmente ebenfalls durchsichtig.
